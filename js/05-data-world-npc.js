...
addSystems([
  ...
  {id:'loot_container_system',n:'LootContainerSystem — лут и контейнеры',g:'g_world',p:0,
    ...
    path:'res://world/loot_system.gd',autoload:null,req:['data_registry','storage_system'],reads:['data/objects (drop_table, resource)'],blocksScenes:false},
  {id:'resource_node_system',n:'ResourceNodeSystem — точки ресурса',g:'g_world',p:1,
    ...
    path:'res://world/resource_node_system.gd',autoload:null,req:['action_system'],reads:[],blocksScenes:false},
  {id:'exploration_tracker',n:'ExplorationTracker — исследование',g:'g_world',p:1,
    ...
    path:'res://world/exploration_tracker.gd',autoload:'ExplorationTracker',req:['transition_manager'],reads:[],blocksScenes:false},
  {id:'fast_travel_system',n:'FastTravelSystem',g:'g_world',p:2,
    ...
    path:'res://world/fast_travel.gd',autoload:'FastTravelSystem',req:['exploration_tracker'],reads:[],blocksScenes:false,
  ...
  {id:'world_state_generator',n:'RoomStateGenerator — состояния комнат/зданий',g:'g_world',p:1,
    ...
    path:'res://world/room_state_generator.gd',autoload:null,req:['time_manager','building_scene_factory'],reads:[],blocksScenes:false},
  ...
  {id:'ai_controller',n:'AIController — AI-контроллер NPC',g:'g_npc',p:1,
    ...
    path:'res://npc/ai_controller.gd',autoload:null,req:['autonomy_ai_hook'],reads:[],blocksScenes:false},
  {id:'perception_system',n:'PerceptionSystem — восприятие',g:'g_npc',p:1,
    ...
    path:'res://npc/perception_system.gd',autoload:null,req:['ai_controller'],reads:[],blocksScenes:false},
  {id:'relationship_system',n:'RelationshipSystem — отношения',g:'g_npc',p:1,
    ...
    path:'res://npc/relationship_system.gd',autoload:'RelationshipSystem',req:['ai_controller'],reads:[],blocksScenes:false},
  {id:'morale_mood_system',n:'MoraleMoodSystem — мораль и настроение',g:'g_npc',p:1,
    ...
    path:'res://npc/morale_system.gd',autoload:null,req:['relationship_system'],reads:[],blocksScenes:false,
  ...
  {id:'event_system',n:'GameEventSystem — система событий',g:'g_npc',p:1,
    ...
    path:'res://npc/event_system.gd',autoload:'GameEventSystem',req:['event_bus','relationship_system'],reads:[],blocksScenes:false},
  {id:'group_system',n:'GroupSystem — группы',g:'g_npc',p:1,
    ...
    path:'res://npc/group_system.gd',autoload:'GroupSystem',req:['relationship_system'],reads:[],blocksScenes:false}
]);
